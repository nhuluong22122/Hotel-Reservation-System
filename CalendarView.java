    ...
    private ActionListener getCalendarViewActionListerner(int offset) {
        ...
        ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GregorianCalendar newYear = new GregorianCalendar(year+offset, month, day);
                model.update(newYear);
            } 
    ...
    private ActionListener getMonthsNavigateListener(JComboBox<MONTHS> c){
        ...
        ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int day = data.get(Calendar.DAY_OF_MONTH);
                GregorianCalendar newMonth = new GregorianCalendar(year, month, day);
                model.update(newMonth);
