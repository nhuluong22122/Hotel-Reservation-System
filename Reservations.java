...
public class Reservations implements Serializable {
	 ...
	 * @postcondition: Room is removed from available rooms and added to the map
	 *                 of occupied rooms
	 */
	 ...
	 *                 of occupied rooms
	 */
	public void addRoom(String checkIn, String checkOut, String roomType)
	 ...
	 * @param e
	 *            the end date
	 * @precondition: date is valid, meaning, end date does not precede start
	 *                date
